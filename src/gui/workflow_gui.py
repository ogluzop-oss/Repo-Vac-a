...
class WorkflowWindow(QWidget):
    ...
    def _tab_bandeja(self):
        ...
        bar.addStretch()
        bar.addWidget(_btn("🔄  Actualizar", self._load_bandeja, primary=True))
        lay.addLayout(bar)
    ...
    def _tab_disenador(self):
        ...
        bar.addWidget(_btn("Sembrar todas", self._seed, primary=True))
        bar.addStretch()
        bar.addWidget(_btn("🔄  Actualizar", self._load_def, primary=True))
        lay.addLayout(bar)
