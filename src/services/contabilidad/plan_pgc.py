...
CUENTAS_PGC = [
    ...
    ("623", "Servicios de profesionales independientes", "gasto", "deudora"),
    ("624", "Transportes", "gasto", "deudora"),
    ("625", "Primas de seguros", "gasto", "deudora"),
    ("626", "Servicios bancarios y similares", "gasto", "deudora"),
    ("627", "Publicidad, propaganda y relaciones públicas", "gasto", "deudora"),
