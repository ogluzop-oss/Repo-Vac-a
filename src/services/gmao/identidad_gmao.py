"""
Adaptador gmao ↔ IOC (Bloque III) — punto oficial por el que gmao resuelve identidad vía IdentityAPI.
Homogéneo: construido sobre el factory único `identidad.adaptador`. Behavior-preserving (empresa_id con
fallback). No accede a Repository/Cache/SQL. Dirección: gmao → IdentityAPI → … → IOC.
"""
