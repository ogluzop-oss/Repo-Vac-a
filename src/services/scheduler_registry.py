...
CATALOGO = {
    ...
    "saas_avisos_vencimiento": ("SaaS · avisos de vencimiento de suscripción a las empresas", "saas", False, 24, "normal", 300, 1, None),
...
REGISTRADORES = [
    ...
    ("src.services.saas.suscripciones", "registrar_jobs_saas_avisos"),
