...
CATALOGO = {
    ...
    "portal_invitaciones_pendientes": ("Portal proveedor · invitaciones sin aceptar", "compras", False, 24, "normal", 300, 1, "compras.ver"),
    "lonja_cierre_subastas": ("Lonja · cierre de subastas vencidas", "compras", False, 1, "alta", 300, 1, "compras.ver"),
...
REGISTRADORES = [
    ...
    ("src.services.compras.portal.jobs", "registrar_jobs_portal"),
    ("src.services.lonja.jobs", "registrar_jobs_lonja"),
